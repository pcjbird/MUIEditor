...
public:
	virtual BOOL IsDropSource() {return m_bDropSource;}
	virtual BOOL CanDragDrop() {return m_bSelected;}
	virtual BOOL IsShareDragImage(){return m_bShareDragImage;}
	void SetDropSource(BOOL bDropSource){m_bDropSource = bDropSource;}
	void SetShareDragImage(BOOL bShareDragImage){m_bShareDragImage = bShareDragImage;}
	virtual CDuiString GetControlShareText() {return m_strShareText;}
	void SetControlShareText(CDuiString strShareText){ m_strShareText = strShareText;}
protected:
    int m_iIndex;
    bool m_bSelected;
    UINT m_uButtonState;
    IListOwnerUI* m_pOwner;
	BOOL			m_bDropSource;
	BOOL            m_bShareDragImage;
	CDuiString		m_strShareText;
};
