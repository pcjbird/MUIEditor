...
namespace DuiLib
{
	COptionUI::COptionUI() : m_bSelected(false), m_dwSelectedTextColor(0),m_bDropSource(FALSE),m_bShareDragImage(TRUE)
	{
	}
	...
	void COptionUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		...
		else if(_tcscmp(pstrName, _T("dropsource")) == 0)
		{
			SetDropSource(_tcscmp(pstrValue, _T("true")) == 0);
		}
		else if(_tcscmp(pstrName, _T("sharedragimage")) == 0)
		{
			SetShareDragImage(_tcscmp(pstrValue, _T("true")) == 0);
		}
